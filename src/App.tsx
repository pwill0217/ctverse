...
function App() {
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex space-x-8">
              <a href="#" className="text-white hover:text-red-600 transition">New Releases</a>
              <a href="#" className="text-white hover:text-red-600 transition">Catalog</a>
  ...
  className="bg-red-600 text-white px-6 py-2 rounded font-semibold hover:bg-red-700 transition flex items-center space-x-2"
>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-red-600 text-white px-8 py-4 rounded font-semibold hover:bg-red-700 transition flex items-center justify-center space-x-2">
